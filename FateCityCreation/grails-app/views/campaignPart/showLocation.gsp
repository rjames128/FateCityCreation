...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'campaignPart.label', default: 'Location')}" />
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="createLocation"><g:message code="default.new.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="show-campaignPart" class="content scaffold-show" role="main">
			...
			<ol class="property-list campaignPart">
				...
				<g:if test="${campaignPartInstance?.locationName}">
				<li class="fieldcontain">
					<span id="locationName-label" class="property-label"><g:message code="campaignPart.locationName.label" default="Location Name" /></span>
					
						<span class="property-value" aria-labelledby="locationName-label"><g:fieldValue bean="${campaignPartInstance}" field="locationName"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${campaignPartInstance?.locationDescription}">
				<li class="fieldcontain">
					<span id="locationDescription-label" class="property-label"><g:message code="campaignPart.locationDescription.label" default="Location Description" /></span>
					
						<span class="property-value" aria-labelledby="locationDescription-label"><g:fieldValue bean="${campaignPartInstance}" field="locationDescription"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="editLocation" id="${campaignPartInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
