			...
			<ol class="property-list campaignPart">
				...
				<li class="fieldcontain">
					<span id="city-label" class="property-label"><g:message code="campaignPart.city.label" default="City" /></span>
						...
						<span class="property-value" aria-labelledby="city-label"><g:link controller="city" action="show" id="${campaignPartInstance?.city?.id}">${campaignPartInstance?.city?.encodeAsHTML()}</g:link></span>
